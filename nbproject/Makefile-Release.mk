...
${OBJECTDIR}/mqtt_biz_info.o: mqtt_biz_info.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/mqtt_biz_info.o mqtt_biz_info.c

${OBJECTDIR}/mqtt_biz_redis.o: mqtt_biz_redis.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/mqtt_biz_redis.o mqtt_biz_redis.c

${OBJECTDIR}/mqtt_cfg.o: mqtt_cfg.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/mqtt_cfg.o mqtt_cfg.c

${OBJECTDIR}/mqtt_ft_server_on_msg_arrvd.o: mqtt_ft_server_on_msg_arrvd.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/mqtt_ft_server_on_msg_arrvd.o mqtt_ft_server_on_msg_arrvd.c

${OBJECTDIR}/redis_cfg.o: redis_cfg.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/redis_cfg.o redis_cfg.c
